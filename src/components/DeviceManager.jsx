        ...
        <div className="dm-wrapper">
            ...
            <style>{`
                ...
                @media (max-width: 600px) {
                    .dm-subtitle { font-size: 11px; }
                    .dm-card { padding: 1rem 0.75rem; }
                    .dm-input-row { gap: 0.5rem; }
                    .dm-input { padding: 0.5rem 0.6rem; font-size: 11px; }
                    .dm-add-btn { padding: 0.5rem 0.75rem; font-size: 11px; gap: 0.25rem; }
                    .dm-list-item { padding: 0.6rem 0.75rem; }
                    .dm-device-name { font-size: 11px; }
                    .dm-delete-btn { font-size: 11px; padding: 0.3rem 0.4rem; }
                }
            `}</style>
        </div>
    );
