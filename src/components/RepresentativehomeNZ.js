...
{/* 
                            ...
                            {/* <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                             ...
                             <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                                <div className="card home_card">
                                    <div className="card-body" style={{ textAlign: "center" }}>
                                         <a href="https://huntsmanoptics.com/wp-content/uploads/2026/04/New-Zealand-Trifold-01-04-2026.pdf" target="_blank" rel="noreferrer">
                                            <img height="100px" width="100px" src="./images/nz.jpg" alt="assets" />
                                            </a>
                                        <h4 className="card-title">Trifold Nz</h4>
                    ...
                    <div className="row no-gutters mt-5 home_row">
                        ...
                        <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                         ...
                         <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                     <a href="https://staffpurchasenz.hointernal.com" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/spf1.jpg" alt="B2B Portal" />
                                        {/* https://forms.gle/ESwC6S3GHQx5txdt5 */}
                                    </a>
                                    <h4 className="card-title">Staff Purchase NZ </h4>
                                </div>
                            </div>
                        </div>
...
{/*                        
                            ...
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                    <a href="https://www.unleashedsoftware.com/academy/" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/XA-products.png" alt="OSO Products" />
                                    </a>
                  ...
                  <div className="oso">
                    <h2 className="under"> Warehouse</h2>
                    <hr style={{ margin: "0",borderTop:"5px solid #ddd" }}></hr>
                    <div className="row no-gutters mt- home_row"style={{justifyContent:"center"}}>
                       
                        <div className="col-xl-12 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                        ...
                        {/* <div className="col-xl-3 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                    <a href="https://docs.google.com/spreadsheets/d/1F1CDTPk7dGhbD8MpUPPHTgIv8Xfh0EYOhW3rMApb5uU/edit?resourcekey=&gid=925125226#gid=925125226" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/excel.png" alt="B2B Portal" />
                                    </a>
                                    <h4 className="card-title">Stock Return Responses</h4>
                                </div>
                            </div>
                        </div>
                         ...
                         <div className="col-xl-3 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                    <a href="https://huntsmanmarch.vercel.app/dashboard" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/rma.png" alt="B2B Portal" />
                                    </a>
                                    <h4 className="card-title">March Offer Responses</h4>
                                </div>
                            </div>
                        </div> */}
                         ...
                         {/* <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                     <a href="https://forms.gle/ESwC6S3GHQx5txdt5" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/SP.png" alt="B2B Portal" />
                                    </a>
                        ...
                        {/* <div className="col-xl-3 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                     <a href="https://staffpurchaseaus.hointernal.com/dashboard" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/res.avif" alt="B2B Portal" />
                                    </a>
                                    <h4 className="card-title">Staff Purchase Responses</h4>
                                </div>
                            </div>
                        </div> */}
                        ...
                        {/* <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                     <a href="https://docs.google.com/forms/u/0/d/10IWm1KGMUhuFfJ-9XqD6nKH5OZ9AzJwhi_uCZRQekoA/viewform?usp=drivesdk&edit_requested=true" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/spsa.jpg" alt="B2B Portal" />
                                    </a>
                                    <h4 className="card-title">Staff Purchase NZ </h4>
                                </div>
                            </div>
