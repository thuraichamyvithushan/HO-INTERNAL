...
{/* 
                            ...
                            {/* <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                             ...
                             <div className="col-xl-2 col-md-4 col-sm-6 mt-3 anime-2 center-card">
                                <div className="card home_card">
                                    <div className="card-body" style={{ textAlign: "center" }}>
                                         <a href="https://huntsmanoptics.com/wp-content/uploads/2026/03/HikMicro-A3-Doublefold-AUSTRALIA-09-03-2026-1-1.pdf" target="_blank" rel="noreferrer">
                                            <img height="100px" width="100px" src="./images/aus.jpg" alt="assets" />
                                            </a>
                                        <h4 className="card-title">Bifold Aus</h4>
