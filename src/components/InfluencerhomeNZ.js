...
const InfluencerHomeGridNZ = function () {
    return (
        <div>
            <div className="container main-cent">
                                ...
                                <div className="card home_card">
                                    <div className="card-body" style={{ textAlign: "center" }}>
                                        <a href="https://huntsmanoptics.com/wp-content/uploads/2026/04/New-Zealand-Trifold-01-04-2026.pdf" target="_blank" rel="noreferrer">
                                            <img height="100px" width="100px" src="./images/nz.jpg" alt="Trifold Nz" />
                                        </a>
                            ...
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
                                    <a href="https://staffpurchasenz.hointernal.com" target="_blank" rel="noreferrer">
                                        <img height="100px" width="100px" src="./images/spf1.jpg" alt="Staff Purchase NZ" />
                                    </a>
                ...
                <div className="oso">
                    ...
                    <div className="row no-gutters mt-5 home_row" style={{ justifyContent: "center" }}>
                        <div className="col-xl-12 col-md-12 col-sm-12 mt-3 anime-2 center-card">
                            <div className="card home_card">
                                <div className="card-body" style={{ textAlign: "center" }}>
...
export default InfluencerHomeGridNZ;
